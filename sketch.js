...
let bgMode = 0; // 0: black, 1: rainbow
let toggleButton;
...
function setup() {
  ...
  toggleButton = createButton("0000");
  toggleButton.position(width - 120, height - 40);
...
function draw() {
  ...
  console.log(`micLevel: ${micLevel.toFixed(4)} | bass: ${bass}`);
}
...
class SymmetricBlob {
  ...
  setThemeColor(index) {
    let hueShift;
    switch (index) {
      case 0: hueShift = 200; break;
      case 1: hueShift = 55; break;
      case 2: hueShift = 270; break;
      case 3: hueShift = 5; break;
    }
